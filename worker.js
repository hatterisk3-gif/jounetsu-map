        ...
        if (isRest) {
          if (!restNotice) {
            ...
            if (wrapper) {
              ...
              restNotice.style.cssText = 'background:#fff3e0; color:#e65100; border:1px solid #ffe0b2; padding:10px; border-radius:8px; margin:10px 0; font-size:13px; font-weight:bold; display:flex; align-items:center; gap:6px;';
